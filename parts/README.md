...
| 엔코더 N20 | 좌우 2구동륜과 회전 펄스 출력 | 모터 전력 입력, CHA 펄스 출력 | v4 |
| AA 4개·5V 벅-부스트 | 차량 모터 전원과 제어보드 전원 공급 | VM과 5V/VIN을 구분 | 차량 |
| 1셀 배터리·충전/보호·3.3V 레귤레이터 | 조종기 ESP32와 BMI270 전원 공급 | 셀 전압과 3.3V 레일을 구분 | v2·v3 조종기 |
